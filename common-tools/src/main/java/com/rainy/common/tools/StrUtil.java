package com.rainy.common.tools;
...
public class StrUtil {
	...
	/**
	* @Title: isBank
	* @Description: 判断字符是否为空白字符(null or 空白符)
	* @param dest
	* @return boolean
	* @throws
	 */
	public static boolean isBlank(String dest){
		return dest == null || dest.trim().length() == 0;
	}
	
	/**
	* @Title: isNotBlank
	* @Description: 判断字符是否为非空白
	* @return boolean
	* @throws
	 */
	...
	public static void main(String[] args) {
		System.out.println(StrUtil.isBlank(" s ad      "));
	}
}
